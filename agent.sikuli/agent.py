...
if exists("1533574629012.png"):
    click("1533574629012-1.png")
...
for i, enemy in enumerate(enemies):
    if exists(enemy):
        ...
        click(enemy)
        if i == 2 or i == 5:
            dragDrop("1533153589813.png", "1533678171774.png")
            dragDrop("1533153698332.png", "1533678323774.png")
        elif i == 3 or i == 6:
            ...
            dragDrop("1533153589813.png", "1533678171774.png")
            dragDrop("1533153698332.png", "1533678323774.png")
            dragDrop("1533153633179.png", "1533752545914.png")
        elif i == 9:
            dragDrop("1533153771268.png", "1533153782427.png")
            hover("1533364668054.png")
            dragDrop("1533153841036.png", Pattern("1533578809832.png").similar(0.85).targetOffset(0,70))
            hover("1533364668054.png")
            dragDrop("1533366176633.png", Pattern("1533366292113.png").similar(0.85).targetOffset(0,-66))
        click("1533154038299.png")
        wait("1533578456670.png", 120)
        click("1533578456670.png")
